...
for DIR in chr*; do
    ...
    HAP0_LIST="${CHR_NAME}-hap0-contigs-revised-2.txt"
    HAP1_LIST="${CHR_NAME}-hap1-contigs-revised-2.txt"

    HAP0_OUTPUT="${CHR_NAME}-hap0-contigs-revised-2.fasta"
    HAP1_OUTPUT="${CHR_NAME}-hap1-contigs-revised-2.fasta"
